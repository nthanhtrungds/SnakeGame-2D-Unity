...
public class PauseWindow : MonoBehaviour {
    ...
    private void Awake() {
        ...
        transform.Find("stopBtn").GetComponent<Button_UI>().ClickFunc = () => Loader.Load(Loader.Scene.MainMenu);
        transform.Find("stopBtn").GetComponent<Button_UI>().AddButtonSounds();
